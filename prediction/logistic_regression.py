...
#	parser.add_argument('--train_file',type=str, default="data/features_1473xspring_processed4_train.csv") # input csv
#	parser.add_argument('--test_file',type=str, default="data/features_1473xspring_processed4_test.csv") # input csv
...
def runLogReg(course_name_train,course_name_test,lead,lag):
	print "Starting Logistic Regression"
	train_file="prediction/data/"+course_name_train+"_processed_train.csv"
	test_file="prediction/data/"+course_name_test+"_processed_test.csv"
	train_auc, test_auc, crossval_auc = load_and_run_regression(train_file,test_file,lead,lag)
	print "RESULT : Test auc: %s. Train auc: %s. Crossval auc: %s" % (test_auc, train_auc, crossval_auc)
	return [test_auc,train_auc,crossval_auc]
